...
return [
    "text:home-header.title" => i::__("<font color='yellow'><b><u>DEVELOPMENT</u></b></font>"),
    "text:home-header.description" => i::__("AMBIENTE DE DESENVOLVIMENTO DO MAPAS MT<br><br>"),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapas MT"),
    "text:home-register.description" => i::__("Contribua com a plataforma livre e interativa de mapeamento do cenário cultural e esportivo e instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas públicas promovidas pela Secretaria de Cultura, Esporte e Lazer de Mato Grosso."),
    'text:home-developers.description' => 'Além disso, Mapas MT é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
